...
<head>
    ...
    <style>
        ...
        * {
        ...
        .title-container {
            background-color: #2da78ddb; /* Azul */
            color: #fff; /* Texto blanco */
            border: 2px solid #2da78ddb; /* Borde Azul */
            border-radius: 10px; /* Borde redondeado */
        ...
        .btn:hover {
            background-color: #199379; /* Azul más oscuro al pasar el ratón */
        }
    </style>
</head>
<body>
...
<div class="container">
    <div class="title-container">
        <h1>Interfaz de Coordinador</h1>
    </div>
    <table>
        <tr>
            <td>
                <div class="cell-container">
                    <a href="MostrarAntepro.jsp">Crear Anteproyecto</a>
                </div>
            </td>
            <td>
                <div class="cell-container">
                    <a href="Informepro.jsp">Informe del Proyecto</a>
                </div>
            </td>
            <td>
                <div class="cell-container">
