...
<head>
    ...
    <style>
        ...
        * {
        ...
        .container {
            width: 40%; /* Reducir el ancho del contenedor */
            padding: 30px;
...
<div class="container">
    ...
    <c:if test="${param.modifica == null}">
        <sql:query var="estudiantes" dataSource="${proyecto}">
    ...
    <form action="" method="POST">
        <c:forEach var="itema" items="${estudiantes.rows}">
            <input type="hidden" id="ced" name="ced"  value="${itema.id}" required>
            ...
            <input type="email" id="correo" name="correo"  value="${itema.correo}" required>
    ...
    <c:if test="${param.modifica != null}">
        ...
        <%-- Redireccionar a MostrarProfesor.jsp después de la actualización --%>
        <c:if test="${result > 0}">
