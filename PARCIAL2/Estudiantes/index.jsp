...
<!--<c:if test="${not empty sessionScope.idEstudiante}">
    El id del estudiante es: ${sessionScope.idEstudiante}
</c:if>-->

<div class="container">
        <h1>Interfaz de Estudiantes</h1>
    <table>
        <tr>
            <td>
                <div class="cell-container">
                    <a href="seleccionarIdea.jsp?id=${sessionScope.idEstudiante}">Ideas de Proyecto de Grado</a>
                </div>
            </td>
            <td>
                <div class="cell-container">
                    <a href="MostrarAntepro.jsp?id=${sessionScope.id_estudiante}">Subir Anteproyecto</a>
                </div>
            </td>
            <td>
                <div class="cell-container">
